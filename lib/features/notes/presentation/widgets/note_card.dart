...
/// Shared between [NoteCard] and the note editor so the two flights match
/// up during the open/close Hero transition.
String noteHeroTag(String noteId) => 'note-hero-$noteId';
